...
- (void)viewDidLoad {
  ...
  [self notifyUpdateUnreadMessageCount];
     [self.navigationController.navigationBar setTitleTextAttributes:@{NSFontAttributeName:kFont(18),NSForegroundColorAttributeName:[UIColor whiteColor]}];
  self.evaStarDic = [NSMutableDictionary dictionary];
    UIButton *button =
    [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 25, 25)];
    UIImageView *imageView =
    [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"btn_writeBack"]];
    imageView.frame = CGRectMake(0, 5,10 , 17);
